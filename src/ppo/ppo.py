...
def get_game_state():
    r = requests.get(SERVER_URL + "getGameSate/fullMap?x=20&y=20")
...
observation_dimensions = board_x * board_y * 2
...
actor.load_weights('./modelsweight_ppo1/cartpole_actor.h5')
critic.load_weights('./modelsweight_ppo1/cartpole_critic.h5')
...
for epoch in range(epochs):
    ...
    # Save the model
    actor.save("modelsweight_ppo1/cartpole_actor"".h5")
    critic.save("modelsweight_ppo1/cartpole_critic.h5")
