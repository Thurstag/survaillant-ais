...
def get_game_state():
    r = requests.get(SERVER_URL + "getGameSate/flashLight?radius=" + str(radius))
...
actor.load_weights('./modelsweight_ppo2/cartpole_actor.h5')
critic.load_weights('./modelsweight_ppo2/cartpole_critic.h5')
...
for epoch in range(epochs):
    ...
    # Save the model
    actor.save("modelsweight_ppo2/cartpole_actor.h5")
    critic.save("modelsweight_ppo2/cartpole_critic.h5")
