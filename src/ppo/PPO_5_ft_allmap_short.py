...
# But the game end at turn 50
# to prevent the area map to mess up training
...
try:
    actor.load_weights('./modelsweight_ppo5/cartpole_actor.h5')
    critic.load_weights('./modelsweight_ppo5/cartpole_critic.h5')
except OSError as e:
...
for epoch in range(epochs):
    ...
    # Save the model
    actor.save("modelsweight_ppo5/cartpole_actor.h5")
    critic.save("modelsweight_ppo5/cartpole_critic.h5")
