...
/**
 * Class generating a tensor used to represent the state of the map at a time T
 */
class StateGenerator {
     ...
     *
     * @return {[number, number, number]} Dimension for each axis
     */
    shape() {
...
class NormalStateGenerator extends StateGenerator {
    ...
    shape() {
        return [ this.#stateDimX, this.#stateDimY, this.tensorInfo.layers ];
    }
...
class FlashlightStateGenerator extends StateGenerator {
    ...
    shape() {
        return [ this.#stateDim, this.#stateDim, this.tensorInfo.layers ];
    }
